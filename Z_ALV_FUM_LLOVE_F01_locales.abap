...
data: lt_sbook type standard table of ty_sbook,
lt_stravelag type standard table of ty_stravelag,
lt_scustom type standard table of ty_scustom,
...
lt_sbook[] = t_sbook[].
sort lt_sbook by agencynum.
delete adjacent duplicates from lt_sbook comparing agencynum.
endif.
...
where agencynum = lt_sbook-agencynum.

if sy-subrc is initial.
lt_stravelag[] = t_stravelag[].
endif.
